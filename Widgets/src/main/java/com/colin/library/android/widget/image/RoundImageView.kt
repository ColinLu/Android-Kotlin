...
class RoundImageView @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.RoundImageView, defStyleAttr, 0) {
            ...
            val index = getInt(R.styleable.RoundImageView_android_scaleType, INVALID)
            ...
            var cornerRadiusOverride = getDimensionPixelSize(
                R.styleable.RoundImageView_round_radius, INVALID
            ).toFloat()
            mCornerRadii!![Corner.TOP_LEFT] = getDimensionPixelSize(
                R.styleable.RoundImageView_round_radius_top_left, INVALID
            ).toFloat()
            mCornerRadii[Corner.TOP_RIGHT] = getDimensionPixelSize(
                R.styleable.RoundImageView_round_radius_top_right, INVALID
            ).toFloat()
            mCornerRadii[Corner.BOTTOM_RIGHT] = getDimensionPixelSize(
                R.styleable.RoundImageView_round_radius_bottom_right, INVALID
            ).toFloat()
            mCornerRadii[Corner.BOTTOM_LEFT] = getDimensionPixelSize(
                R.styleable.RoundImageView_round_radius_bottom_left, INVALID
            ).toFloat()
