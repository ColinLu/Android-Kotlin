...
class ViewReplacer(sourceView: View) {
    ...
    fun replace(targetView: View) {
        ...
        checkParent()
        if (mSourceParentView != null || mSourceViewIndexInParent != INVALID) {
