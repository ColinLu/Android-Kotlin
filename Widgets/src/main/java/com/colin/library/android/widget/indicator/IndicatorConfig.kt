...
import com.colin.library.android.widget.INDICATOR_HEIGHT
import com.colin.library.android.widget.INDICATOR_MARGIN
...
class IndicatorConfig {
    ...
    private var indicatorSpace = INDICATOR_SPACE
    private var normalWidth = INDICATOR_NORMAL_WIDTH
    private var selectedWidth = INDICATOR_SELECTED_WIDTH
    private var normalHeight = INDICATOR_SELECTED_WIDTH
    private var selectedHeight = INDICATOR_SELECTED_WIDTH
    ...
    private var radius = INDICATOR_RADIUS
    private var height = INDICATOR_HEIGHT
    ...
    class Margins {
        ...
        constructor() : this(INDICATOR_MARGIN)
