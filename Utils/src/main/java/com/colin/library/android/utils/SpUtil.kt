...
object SpUtil {
    ...
    @JvmOverloads
    fun getBoolean(
        key: String, def: Boolean = false, name: String = SP_NAME, mode: Int = Context.MODE_PRIVATE
    ...
    @JvmOverloads
    fun getString(
        key: String, def: String? = null, name: String = SP_NAME, mode: Int = Context.MODE_PRIVATE
