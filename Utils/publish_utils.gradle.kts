    ...
    publishing.publications {
        register<MavenPublication>("release") {
            ...
            pom.withXml {
                ...
                root.appendNode("url", "https://gitee.com/colin_lu/Android-Kotlin")
                ...
                scmNode.appendNode(
                    "connection", "scm:git:https://gitee.com/colin_lu/Android-Kotlin.git"
                )
                scmNode.appendNode(
                    "developerConnection", "scm:git:ssh://git@gitee.com:colin_lu/Android-Kotlin.git"
                )
                scmNode.appendNode("url", "https://gitee.com/colin_lu/Android-Kotlin")
            }
        }
    }
