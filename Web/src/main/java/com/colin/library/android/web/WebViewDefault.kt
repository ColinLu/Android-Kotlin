 ...
 * Des   :CustomWebView
 */
class WebViewDefault @JvmOverloads constructor(
    ...
    init {
        context.withStyledAttributes(attrs, R.styleable.WebViewDefault, defStyleAttr, 0) {
            javascriptEnabled =
                getBoolean(R.styleable.WebViewDefault_javascriptEnabled, javascriptEnabled)
        }
    ...
    fun client(callback: IWebViewCallback) {
